...
def grade_assignment(pdf_path):
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "你是一位严谨的机械原理课程教师。"},
...
def main():
    ...
    chapter_folders = [
        f
        for f in chapter_folders
        if not any(excluded in f.name for excluded in excluded_paths)
    ]
